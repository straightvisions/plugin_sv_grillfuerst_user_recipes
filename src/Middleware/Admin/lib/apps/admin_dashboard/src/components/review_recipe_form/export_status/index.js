...
const ExportStatus = (attributes) => {
	...
	useEffect(() => {
		const fetchJobs = async () => {
			try {
				...
				const response = await fetch(route + '/status'); // replace with your actual endpoint
	...
	// Filter and categorize jobs based on type
	...
	return (
		<div className="mt-5 bg-white px-4 py-5 shadow sm:rounded-lg sm:p-6 mb-4">
			<h3 className="text-lg font-medium leading-6 text-gray-900 mb-2">Export Status</h3>
