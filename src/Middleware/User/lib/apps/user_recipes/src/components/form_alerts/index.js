...
export function AlertReviewPending() {
	return (
		<div className="flex items-center bg-blue-500 text-white font-bold px-4 py-3" role="alert">
			...
			<p>Dein Rezept wird derzeit geprüft und <strong>kann</strong> aktuell nicht weiter bearbeitet werden. Du <strong>erhältst</strong> eine Nachricht, wenn es Änderungsvorschläge <strong>von uns</strong> gibt oder dein Rezept veröffentlich wurde. </p>
		</div>
	);
}
