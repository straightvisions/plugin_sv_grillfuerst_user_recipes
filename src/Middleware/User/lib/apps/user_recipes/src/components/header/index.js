			...
			{ user.isLoggedIn && currentPath === routes.config.appPath &&
				<div className="mb-12">
					...
					<div className="flex flex-wrap lg:flex-nowrap mb-4 gap-12 justify-between items-center bg-grey-50 rounded shadow">
						<div className="p-4">
							<p className="mt-2">Du befindest dich nun in deinem persönlichen Login Bereich, in dem du neue Rezepte erstellen und zur Prüfung freigeben kannst. Bitte halte dich beim Erstellen an unsere <a className="underline" href="http://grillfuerst.de/magazin/news/community-rezepte/" target="_blank">Guidelines</a>, denn natürlich möchten wir unsere Community möglichst mit hochwertigen Rezepten und Inhalten bereichern.</p>
							<p className="mt-2">Eine Übersicht aller veröffentlichten Community-Rezepte findest du im Magazin im Bereich <a className="underline" href="http://grillfuerst.de/magazin/news/community-rezepte/" target="_blank">Grillrezepte</a>.</p>
