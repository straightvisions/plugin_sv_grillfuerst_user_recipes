	...
	return (
		...
		>
			<div className={
				...
				<div className="max-w-max flex flex-wrap justify-center text-gray-600">
					<label
						className="relative cursor-pointer font-bold text-orange-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-orange-500 focus-within:ring-offset-2"
					>
						{label !== '' &&
							<span>{label}</span>
						}
					...
					{subLabel !== '' &&
						<p className="pl-1 font-medium">{subLabel}</p>
					}
				</div>
