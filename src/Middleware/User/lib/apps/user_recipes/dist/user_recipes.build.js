...
module.exports = __webpack_require__.p + "38b97c6ef120ced0ae6c.woff2";
...
module.exports = __webpack_require__.p + "88fe3c2ba5b7692bf3c4.woff2";
...
;// CONCATENATED MODULE: ./node_modules/@heroicons/react/20/solid/esm/ArrowRightIcon.js
...
;// CONCATENATED MODULE: ./node_modules/@heroicons/react/20/solid/esm/PlusIcon.js
...
const PlusIcon_ForwardRef = react.forwardRef(PlusIcon);
/* harmony default export */ const esm_PlusIcon = (PlusIcon_ForwardRef);
;// CONCATENATED MODULE: ./src/models/routes/index.js
var root = 'https://relaunch-magazin.grillfuerst.de/wp-json/sv-grillfuerst-user-recipes/v1';
/* harmony default export */ const routes = ({
  "getRecipes": root + '/recipes',
  // GET
  "getRecipesByUser": root + '/recipes/user/',
  // GET + {user_id}
  "getRecipeByUuid": root + '/recipes/',
  // GET + {recipe_id}
  "createRecipe": root + '/recipes/user/',
  // POST + {user_id}
  "updateRecipe": root * '/recipes/',
  // PUT + {recipe_id}
...
function FormButton(props) {
  ...
  var handleNewRecipe = function handleNewRecipe() {
    // @todo add optical representation (loader)

    fetch(routes.createRecipe + props.user.id).then(function (response) {
  ...
  if (location.pathname.includes('/edit/')) {
    return /*#__PURE__*/react.createElement(Link, {
      ...
      role: "button",
      to: "/"
    }, /*#__PURE__*/react.createElement(esm_ArrowRightIcon, {
      className: "-ml-1 mr-2 h-5 w-5",
      "aria-hidden": "true"
    }), /*#__PURE__*/react.createElement("span", null, "\xDCbersicht"));
  }
  ...
  return /*#__PURE__*/react.createElement("button", {
    ...
    className: "-ml-1 mr-2 h-5 w-5",
    "aria-hidden": "true"
  }), /*#__PURE__*/react.createElement("span", null, "Neues Rezept"));
}
function Header(props) {
  return /*#__PURE__*/react.createElement("div", {
    className: "px-4 sm:px-6 lg:px-8 mb-4 bg-white shadow"
  ...
  }, /*#__PURE__*/react.createElement(FormButton, props)), /*#__PURE__*/react.createElement("div", {
...
;// CONCATENATED MODULE: ./src/components/recipes/index.js
...
function Recipes(props) {
  ...
  (0,react.useEffect)(function () {
    fetch(routes.getRecipesByUser + props.user.id).then(function (response) {
      return response.json();
    }).then(function (data) {
      return setRecipes(data.items);
    });
  }, []);
  ...
  return /*#__PURE__*/react.createElement("div", {
  ...
  }, "Rezept"), /*#__PURE__*/react.createElement("th", {
    scope: "col",
    ...
    return /*#__PURE__*/react.createElement("tr", {
      ...
      onClick: function onClick() {
        return navigate('/edit/' + recipe.uuid);
      }
    ...
    }, recipe.featured_image.url && /*#__PURE__*/react.createElement("img", {
    ...
    }, recipe.created)))), /*#__PURE__*/react.createElement("td", {
...
;// CONCATENATED MODULE: ./src/components/form_image/index.js
function form_image_slicedToArray(arr, i) { return form_image_arrayWithHoles(arr) || form_image_iterableToArrayLimit(arr, i) || form_image_unsupportedIterableToArray(arr, i) || form_image_nonIterableRest(); }
function form_image_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function form_image_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return form_image_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return form_image_arrayLikeToArray(o, minLen); }
function form_image_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }
function form_image_iterableToArrayLimit(arr, i) { var _i = arr == null ? null : typeof Symbol !== "undefined" && arr[Symbol.iterator] || arr["@@iterator"]; if (_i == null) return; var _arr = []; var _n = true; var _d = false; var _s, _e; try { for (_i = _i.call(arr); !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }
function form_image_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }

function Image(props) {
  var _useState = (0,react.useState)(props),
    _useState2 = form_image_slicedToArray(_useState, 2),
    getImage = _useState2[0],
    setImage = _useState2[1];
  var img_url = 'data:image/svg+xml;base64,';
  if (getImage.props.url) {
    img_url = getImage.props.url;
  }
  return /*#__PURE__*/react.createElement("div", {
    className: "h-full relative overflow-hidden mt-1 flex justify-center rounded-md p-6"
  }, /*#__PURE__*/react.createElement("div", {
    ...
    className: "h-fit m-auto p-6 space-y-1 bg-opacity-90 bg-white z-10 text-center rounded-md border-gray-300"
  ...
  }, /*#__PURE__*/react.createElement("span", null, "Bild hochladen"), /*#__PURE__*/react.createElement("input", {
    type: "file",
    accept: "image/*",
    className: "sr-only"
  })), /*#__PURE__*/react.createElement("p", {
    className: "pl-1"
  }, "oder per Drag & Drop ablegen")), /*#__PURE__*/react.createElement("p", {
    className: "text-xs text-gray-500"
  }, "PNG oder JPG")));
}
;// CONCATENATED MODULE: ./src/components/form_common/index.js
...
function Common(props) {
  ...
  return /*#__PURE__*/react.createElement("div", {
  ...
  }, "Allgemeines"), /*#__PURE__*/react.createElement("p", {
    className: "mt-1 text-sm text-gray-500"
  }, "Bearbeite hier die Basisinformationen zu deinem Rezept.")), /*#__PURE__*/react.createElement("div", {
    className: "mt-5 space-y-6 md:col-span-3 md:mt-0"
  }, /*#__PURE__*/react.createElement("div", {
    ...
    placeholder: "Leckere Grillspie\xDFe"
  }))), /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("label", {
    htmlFor: "recipe_excerpt",
    className: "block text-sm font-medium text-gray-700"
    ...
    placeholder: "Die leckersten Grillspie\xDFe...",
    value: formState.excerpt
  })), /*#__PURE__*/react.createElement("p", {
    className: "mt-2 text-sm text-gray-500"
  }, "Eine knackige Zusammenfassung oder Einf\xFChrung in dein Rezept.")), /*#__PURE__*/react.createElement("div", {
    className: "h-200 rounded-md overflow-hidden"
  }, /*#__PURE__*/react.createElement("label", {
    className: "block text-sm font-medium text-gray-700"
  }, "Hauptbild"), /*#__PURE__*/react.createElement(Image, {
    props: formState.featured_image
  })), /*#__PURE__*/react.createElement("div", {
    className: "md:grid md:grid-cols-3 md:gap-6"
  }, /*#__PURE__*/react.createElement("div", {
    className: "mb-5"
  }, /*#__PURE__*/react.createElement("label", {
    htmlFor: "recipe_menu_type",
    className: "block text-sm font-medium text-gray-700"
  }, "Men\xFCart"), /*#__PURE__*/react.createElement("div", {
    className: "mt-1 flex rounded-md shadow-sm"
    ...
    value: "594"
  }, "Beilage"), /*#__PURE__*/react.createElement("option", null, "..."), /*#__PURE__*/react.createElement("option", null, "...")))), /*#__PURE__*/react.createElement("div", {
    className: "mb-5"
  }, /*#__PURE__*/react.createElement("label", {
    htmlFor: "recipe_kitchen_style",
    className: "block text-sm font-medium text-gray-700"
  }, "K\xFCchenstil"), /*#__PURE__*/react.createElement("div", {
    className: "mt-1 flex rounded-md shadow-sm"
  }, /*#__PURE__*/react.createElement("select", {
    ...
    value: "585"
  }, "Fisch"), /*#__PURE__*/react.createElement("option", null, "..."), /*#__PURE__*/react.createElement("option", null, "...")))), /*#__PURE__*/react.createElement("div", {
    className: "mb-5"
  }, /*#__PURE__*/react.createElement("label", {
    htmlFor: "recipe_difficulty",
    className: "block text-sm font-medium text-gray-700"
    ...
    value: "easy "
  }, "leicht"), /*#__PURE__*/react.createElement("option", {
    value: "medium"
  }, "mittel"), /*#__PURE__*/react.createElement("option", {
    value: "difficult"
  }, "schwer"))))), /*#__PURE__*/react.createElement("div", {
    className: "md:grid md:grid-cols-3 md:gap-6"
  }, /*#__PURE__*/react.createElement("div", {
    className: "mb-5"
  }, /*#__PURE__*/react.createElement("label", {
    ...
    className: "block text-sm font-medium text-gray-700"
  }, "Vorbereitungszeit"), /*#__PURE__*/react.createElement("div", {
    className: "mt-1 flex rounded-md shadow-sm"
  }, /*#__PURE__*/react.createElement("input", {
    type: "number",
    ...
    htmlFor: "recipe_cooking_time",
    className: "block text-sm font-medium text-gray-700"
  }, "Kochzeit"), /*#__PURE__*/react.createElement("div", {
    className: "mt-1 flex rounded-md shadow-sm"
  }, /*#__PURE__*/react.createElement("input", {
    type: "number",
    ...
    htmlFor: "recipe_waiting_time",
    className: "block text-sm font-medium text-gray-700"
  }, "Wartezeit"), /*#__PURE__*/react.createElement("div", {
    className: "mt-1 flex rounded-md shadow-sm"
  }, /*#__PURE__*/react.createElement("input", {
    type: "number",
...
;// CONCATENATED MODULE: ./src/components/local_storage/index.js
function local_storage_slicedToArray(arr, i) { return local_storage_arrayWithHoles(arr) || local_storage_iterableToArrayLimit(arr, i) || local_storage_unsupportedIterableToArray(arr, i) || local_storage_nonIterableRest(); }
function local_storage_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function local_storage_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return local_storage_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return local_storage_arrayLikeToArray(o, minLen); }
function local_storage_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }
function local_storage_iterableToArrayLimit(arr, i) { var _i = arr == null ? null : typeof Symbol !== "undefined" && arr[Symbol.iterator] || arr["@@iterator"]; if (_i == null) return; var _arr = []; var _n = true; var _d = false; var _s, _e; try { for (_i = _i.call(arr); !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }
function local_storage_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }

function LocalStorage(key, initialValue) {
  key = "gf_user_recipes_" + key;
  ...
  var _useState = (0,react.useState)(function () {
    ...
    _useState2 = local_storage_slicedToArray(_useState, 2),
...
;// CONCATENATED MODULE: ./src/components/form_ingredients/index.js
function form_ingredients_slicedToArray(arr, i) { return form_ingredients_arrayWithHoles(arr) || form_ingredients_iterableToArrayLimit(arr, i) || form_ingredients_unsupportedIterableToArray(arr, i) || form_ingredients_nonIterableRest(); }
function form_ingredients_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function form_ingredients_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return form_ingredients_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return form_ingredients_arrayLikeToArray(o, minLen); }
function form_ingredients_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }
function form_ingredients_iterableToArrayLimit(arr, i) { var _i = arr == null ? null : typeof Symbol !== "undefined" && arr[Symbol.iterator] || arr["@@iterator"]; if (_i == null) return; var _arr = []; var _n = true; var _d = false; var _s, _e; try { for (_i = _i.call(arr); !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }
function form_ingredients_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }



function Ingredients(props) {
  var _LocalStorage = LocalStorage("ingredients", props.formState.ingredients),
    _LocalStorage2 = form_ingredients_slicedToArray(_LocalStorage, 2),
    ingredients = _LocalStorage2[0],
    setIngredients = _LocalStorage2[1];
  var _useState = (0,react.useState)("ingredientsDB", []),
    _useState2 = form_ingredients_slicedToArray(_useState, 2),
    ingredientsDB = _useState2[0],
    setingredientsDB = _useState2[1]; // data from db
  ...
  (0,react.useEffect)(function () {
    fetch(routes.getIngredients).then(function (response) {
      return response.json();
    }).then(function (data) {
      return setingredientsDB(data.items);
    });
  }, []);
  // needs custom function to apply data to the right array item
  var setIngredient = function setIngredient(item) {
  ...
  var removeIngredient = function removeIngredient(item) {
    // filter out the item from list
    var newIngredients = ingredients.filter(function (ingredient) {
      return ingredient.id !== item.id;
    });
    setIngredients(newIngredients);
  };
  var _LocalStorage3 = LocalStorage("servings", props.formState.servings),
    _LocalStorage4 = form_ingredients_slicedToArray(_LocalStorage3, 2),
    servings = _LocalStorage4[0],
    setservings = _LocalStorage4[1];
  return /*#__PURE__*/react.createElement("div", {
    className: "bg-white px-4 py-5 shadow sm:rounded-lg sm:p-6"
  }, /*#__PURE__*/react.createElement("div", {
    className: "md:grid md:grid-cols-4 md:gap-6"
    ...
    className: "text-lg font-medium leading-6 text-gray-900"
  }, "Zutaten"), /*#__PURE__*/react.createElement("p", {
    className: "mt-1 text-sm text-gray-500"
  }, "Gib alle Zutaten ein, die f\xFCr das Rezept ben\xF6tigt werden."), /*#__PURE__*/react.createElement("div", {
    className: "col-span-6 sm:col-span-4 my-4"
  }, /*#__PURE__*/react.createElement("label", {
    htmlFor: "recipe_servings",
    className: "mr-4 text-sm font-medium text-gray-700"
  }, "Rezept f\xFCr"), /*#__PURE__*/react.createElement("select", {
    value: servings,
    ...
    htmlFor: "search_ingredient",
    className: "block text-sm font-medium text-gray-700"
  }, "Neue Zutat hinzuf\xFCgen"), /*#__PURE__*/react.createElement("div", {
    className: "mt-1 mb-5 flex rounded-md shadow-sm"
  }, /*#__PURE__*/react.createElement("input", {
    type: "text",
    ...
    className: "p-2 bg-green-300 rounded-md text-sm cursor-pointer"
  }, "Zuckermais"), /*#__PURE__*/react.createElement("span", {
    className: "p-2 bg-green-300 rounded-md text-sm cursor-pointer"
  }, "Zucker"), /*#__PURE__*/react.createElement("span", {
    className: "p-2 bg-green-300 rounded-md text-sm cursor-pointer"
  }, "Zunge")))), /*#__PURE__*/react.createElement("div", {
    className: "mt-5 md:col-span-3 md:mt-0 overflow-x-auto"
  }, /*#__PURE__*/react.createElement("table", {
    className: "min-w-full divide-y divide-gray-300"
  }, /*#__PURE__*/react.createElement("thead", {
    className: "bg-gray-50"
    ...
    scope: "col",
    className: "py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6"
  }, "Zutat"), /*#__PURE__*/react.createElement("th", {
    scope: "col",
    className: "px-3 py-3.5 text-left text-sm font-semibold text-gray-900"
  }, "Menge"), /*#__PURE__*/react.createElement("th", {
    scope: "col",
    className: "px-3 py-3.5 text-left text-sm font-semibold text-gray-900"
  }, "Einheit"), /*#__PURE__*/react.createElement("th", {
    scope: "col",
    className: "px-3 py-3.5 text-left text-sm font-semibold text-gray-900"
  }, "Anmerkung"), /*#__PURE__*/react.createElement("th", {
    scope: "col",
    className: "relative py-3.5 pl-3 pr-4 sm:pr-6"
  }, /*#__PURE__*/react.createElement("span", {
    className: "sr-only"
  }, "L\xF6schen")))), /*#__PURE__*/react.createElement("tbody", {
    className: "divide-y divide-gray-200 bg-white"
    ...
    return /*#__PURE__*/react.createElement("tr", {
    ...
    }, ingredient.label), /*#__PURE__*/react.createElement("td", {
      className: "whitespace-nowrap px-3 py-4 text-sm text-gray-500"
    }, /*#__PURE__*/react.createElement("input", {
      ...
      value: ""
    }, "St\xFCck"), /*#__PURE__*/react.createElement("option", {
      value: "g"
    }, "Gramm"), /*#__PURE__*/react.createElement("option", {
      value: "kg"
    }, "Kilo"), /*#__PURE__*/react.createElement("option", null, "..."))), /*#__PURE__*/react.createElement("td", {
      className: "whitespace-nowrap px-3 py-4 text-sm text-gray-500"
    }, /*#__PURE__*/react.createElement("input", {
      type: "text",
      ...
      className: "sr-only"
    }, ingredient.label, " Entfernen"))));
  }))))));
}
;// CONCATENATED MODULE: ./src/components/form_steps/index.js
function form_steps_slicedToArray(arr, i) { return form_steps_arrayWithHoles(arr) || form_steps_iterableToArrayLimit(arr, i) || form_steps_unsupportedIterableToArray(arr, i) || form_steps_nonIterableRest(); }
function form_steps_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function form_steps_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return form_steps_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return form_steps_arrayLikeToArray(o, minLen); }
function form_steps_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }
function form_steps_iterableToArrayLimit(arr, i) { var _i = arr == null ? null : typeof Symbol !== "undefined" && arr[Symbol.iterator] || arr["@@iterator"]; if (_i == null) return; var _arr = []; var _n = true; var _d = false; var _s, _e; try { for (_i = _i.call(arr); !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }
function form_steps_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }



function Steps(props) {
  var _LocalStorage = LocalStorage("steps", props.formState.steps),
    _LocalStorage2 = form_steps_slicedToArray(_LocalStorage, 2),
    steps = _LocalStorage2[0],
    setSteps = _LocalStorage2[1];
  ...
  // needs custom function to apply data to the right array item
  var setStep = function setStep(item) {
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    className: "text-lg font-medium leading-6 text-gray-900"
  }, "Schritte"), /*#__PURE__*/react.createElement("p", {
    className: "mt-1 text-sm text-gray-500"
  }, "Gib alle Zubereitungsschritte ein."), /*#__PURE__*/react.createElement("div", {
    className: "col-span-6 sm:col-span-4 my-4"
  }, /*#__PURE__*/react.createElement("button", {
  ...
  }, "Schritt hinzuf\xFCgen"))), /*#__PURE__*/react.createElement("div", {
    className: "mt-5 md:col-span-3 md:mt-0 overflow-x-auto"
  }, /*#__PURE__*/react.createElement("table", {
    className: "min-w-full divide-y divide-gray-300"
  }, /*#__PURE__*/react.createElement("thead", {
    ...
    scope: "col",
    className: "py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6"
  }, "Schritt"), /*#__PURE__*/react.createElement("th", {
    scope: "col",
    className: "py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6"
  }, "Bild"), /*#__PURE__*/react.createElement("th", {
    scope: "col",
    className: "px-3 py-3.5 text-left text-sm font-semibold text-gray-900"
    ...
    return /*#__PURE__*/react.createElement("tr", {
      ...
      className: "bg-black text-white p-3 rounded-full w-10 h-10 font-bold text-center cursor-pointer"
    }, index + 1)), /*#__PURE__*/react.createElement("td", {
      className: "h-72 rounded-md overflow-hidden whitespace-nowrap py-4 text-sm font-medium text-gray-900"
    }, /*#__PURE__*/react.createElement(Image, {
      props: step.image
    })), /*#__PURE__*/react.createElement("td", {
      className: "whitespace-nowrap px-3 py-4 text-sm text-gray-500 w-full"
    }, /*#__PURE__*/react.createElement("textarea", {
      rows: 12,
      ...
      className: "sr-only"
    }, "Schritt ", index + 1, " Entfernen"))));
  }))))));
}
;// CONCATENATED MODULE: ./src/components/form_submit/index.js
...
function Submit(props) {
  return /*#__PURE__*/react.createElement("div", {
    ...
    className: "text-lg font-medium leading-6 text-gray-900"
  }, "Rezept einreichen"), /*#__PURE__*/react.createElement("p", {
    className: "mt-1 text-sm text-gray-500"
  }, "Wir pr\xFCfen dein Rezept und geben dir Feedback. Sobald wir dein Rezept annehmen, erh\xE4ltst du von uns einen Gutschein f\xFCr den Grillf\xFCrst-Shop.")), /*#__PURE__*/react.createElement("div", {
    className: "mt-5 space-y-6 md:col-span-3 md:mt-0"
    ...
    "aria-hidden": "true"
  }, "Bitte best\xE4tigen"), /*#__PURE__*/react.createElement("div", {
  ...
  }, "Rechteabtretung"), /*#__PURE__*/react.createElement("p", {
    className: "text-gray-500"
  }, "Du best\xE4tigst, alle Rechte an dem Rezept und den Bildern zu besitzen und trittst diese an uns ab."))), /*#__PURE__*/react.createElement("div", {
    className: "flex items-start"
  }, /*#__PURE__*/react.createElement("div", {
    className: "flex h-5 items-center"
  }, /*#__PURE__*/react.createElement("input", {
    ...
    htmlFor: "newsletter",
    className: "font-medium text-gray-700"
  }, "Newsletteranmeldung"), /*#__PURE__*/react.createElement("p", {
    className: "text-gray-500"
  }, "Manche Rezepte stellen wir in unserem Newsletter vor - nicht verpassen!"))))))), /*#__PURE__*/react.createElement("div", {
...
;// CONCATENATED MODULE: ./src/models/recipe/index.js
/* harmony default export */ const recipe = ({
  "user_id": 1,
...
function form_Form(props) {
  ...
  var formStateSlug = 'formState' + params.uuid; // multiple tabs support anyone?
  var _LocalStorage = LocalStorage(formStateSlug, recipe),
    _LocalStorage2 = form_slicedToArray(_LocalStorage, 2),
    formState = _LocalStorage2[0],
    setFormState = _LocalStorage2[1];
  (0,react.useEffect)(function () {
    fetch(routes.getRecipeByUuid + params.uuid).then(function (response) {
      return response.json();
    }).then(function (data) {
      setFormState(data);
    });
  ...
  }, /*#__PURE__*/react.createElement(Common, {
    formState: formState,
...
/* harmony default export */ const models_user = ({
  "id": 1,
  // @todo replace this later
  "avatar": "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"
});
;// CONCATENATED MODULE: ./node_modules/@heroicons/react/20/solid/esm/AdjustmentsVerticalIcon.js
...
const AdjustmentsVerticalIcon_ForwardRef = react.forwardRef(AdjustmentsVerticalIcon);
/* harmony default export */ const esm_AdjustmentsVerticalIcon = (AdjustmentsVerticalIcon_ForwardRef);
;// CONCATENATED MODULE: ./node_modules/@heroicons/react/20/solid/esm/ArrowPathIcon.js
...
const ArrowPathIcon_ForwardRef = react.forwardRef(ArrowPathIcon);
/* harmony default export */ const esm_ArrowPathIcon = (ArrowPathIcon_ForwardRef);
;// CONCATENATED MODULE: ./src/components/dev/index.js
...
function Dev() {
  ...
  return /*#__PURE__*/react.createElement("footer", {
    className: "bg-white shadow sm:rounded-lg my-6"
  }, /*#__PURE__*/react.createElement("div", {
    ...
    className: "flex flex-shrink-0 items-center"
  }, /*#__PURE__*/react.createElement(esm_AdjustmentsVerticalIcon, {
    className: "h-5 w-5",
    "aria-hidden": "true"
  }))), /*#__PURE__*/react.createElement("div", {
...
var App = function App() {
  var _LocalStorage = LocalStorage("user", models_user),
    _LocalStorage2 = app_slicedToArray(_LocalStorage, 2),
    user = _LocalStorage2[0],
    setUser = _LocalStorage2[1];
  var navigate = dist_useNavigate();
  return /*#__PURE__*/react.createElement("div", {
    ...
    path: "/edit/:uuid",
    element: /*#__PURE__*/react.createElement(form_Form, null)
  }), /*#__PURE__*/react.createElement(Route, {
    path: "/",
    element: /*#__PURE__*/react.createElement(Recipes, {
      user: user
    })
  })), /*#__PURE__*/react.createElement(Dev, {
    user: user
  }));
};
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js!./src/tailwind.css
var tailwind = __webpack_require__(414);
;// CONCATENATED MODULE: ./src/tailwind.css
...
var update = injectStylesIntoStyleTag_default()(tailwind/* default */.Z, options);
       ...
       /* harmony default export */ const src_tailwind = (tailwind/* default */.Z && tailwind/* default.locals */.Z.locals ? tailwind/* default.locals */.Z.locals : undefined);
...
var container = document.getElementById('sv-grillfuerst-user-recipes-app');
var src_root = (0,client/* createRoot */.s)(container);
src_root.render( /*#__PURE__*/react.createElement(BrowserRouter, null, /*#__PURE__*/react.createElement(app, null)));
})();
