...
use SV_Grillfuerst_User_Recipes\Middleware\Export\Models\Image_Model;
use SV_Grillfuerst_User_Recipes\Middleware\Export\Models\User_Model;
...
class Recipe_Model {
    ...
    public function __construct(){
        // object types
        $this->featured_image = new Image_Model();
        $this->user_meta = new User_Model();
    }
