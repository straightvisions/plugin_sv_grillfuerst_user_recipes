...
use SV_Grillfuerst_User_Recipes\Middleware\Recipes\Repository\Menu_Types_Finder_Repository;

final class Recipe_Menu_Types_Finder_Service {
    private Menu_Types_Finder_Repository $repository;

    public function __construct(Menu_Types_Finder_Repository $repository) {
